 ...
 *
 * TCP bus between the native CarPlay hook and Java.
 * Java is the long-lived server on 127.0.0.1:19810; the native hook is the
 * client. Route Guidance updates flow native -> Java; the protocol also
 * supports small Java -> native control messages.
 *
 * Written for the legacy JVM used by the target LSD runtime: no generics, lambdas or try-with-resources.
 */
...
public class CarplayBus {
    ...
    /* Debug/control constants retained for wire compatibility. */
