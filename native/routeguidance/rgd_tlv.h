 ...
 *
 * Matches the reference RouteGuidanceDisplayComponent layout (9 TLVs, IDs 0-8).
...
/*
 * RouteGuidanceState values observed in reference route-guidance type information.
 *
 ...
 * Maneuver types.
 *
 * Verified against reference route-guidance type information
...
/*
 * Distance units observed in reference route-guidance type information.
 *
...
/*
 * Driving side as observed in reference renderer logging and captured iAP2 packets:
...
/*
 * Exit info (MAN_TLV_EXIT_INFO) in the reference route-guidance processor is treated as a string and fed into util::UnicodeString8
